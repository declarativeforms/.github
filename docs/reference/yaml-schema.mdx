...
Supported locales: `en`, `es`. Any field that accepts `string | LocaleMap` can use either format. See [Reach Anyone in Their Language](/guides/localization) for full resolution rules.
